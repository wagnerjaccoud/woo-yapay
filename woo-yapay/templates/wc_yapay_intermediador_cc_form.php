...
function showVisualCardCheckout(){
    jQuery("form.checkout").card({
        ...
        formSelectors: {
            	numberInput: 'input#wc-yapay_intermediador-cc-card-number', 
        		expiryInput: 'input#wc-yapay_intermediador-cc-card-expiry', 
       			cvcInput: 'input#wc-yapay_intermediador-cc-card-cvc',
        		nameInput: 'input#wc-yapay_intermediador-cc-card-holder-name'
        },
        messages: {
            validDate: 'Válido\naté',
            monthYear: 'mês/ano',
...
function showVisualCardOrderPay(){
    if (document.getElementById("wc-yapay_intermediador-cc-payment-form")) {
        jQuery("#order_review").card({
            container: '#wc-yapay_intermediador-cc-payment-form',
            formSelectors: {
                numberInput: 'input#wc-yapay_intermediador-cc-card-number', 
        		expiryInput: 'input#wc-yapay_intermediador-cc-card-expiry', 
       			cvcInput: 'input#wc-yapay_intermediador-cc-card-cvc',
...
function resetFields(){
    ...
    jQuery("#wc-yapay_intermediador-cc-card-holder-name").val('');
    jQuery("#wc-yapay_intermediador-cc-card-expiry").val('');
    jQuery("#wc-yapay_intermediador-cc-card-cvc").val('');
    jQuery("#wc-wc-yapay_intermediador-cc-card-installments").val(0);
    jQuery("#yapay_cpfC").val('');
}

function setCardType(){
    var cardNum = jQuery("#wc-yapay_intermediador-cc-card-number");
	...
	jQuery(".jp-card").removeClass('jp-card-hipercard');
	...
	else if (cardNum.hasClass('elo')){
        jQuery(".jp-card").addClass('jp-card-elo jp-card-identified');
    }
	else if (cardNum.hasClass('jcb')){
        jQuery(".jp-card").addClass('jp-card-jcb jp-card-identified');
    }
	else if (cardNum.hasClass('aura')){
        jQuery(".jp-card").addClass('jp-card-aura jp-card-identified');
    }
	else if (cardNum.hasClass('hipercard')){
        jQuery(".jp-card").addClass('jp-card-hipercard jp-card-identified');
    }
	else if (cardNum.hasClass('american-express')){
        jQuery(".jp-card").addClass('jp-card-american-express jp-card-identified');
    }
	
}

//Set the visual card type
jQuery(document).on('keyup keydown change past', '#wc-yapay_intermediador-cc-card-number', function(){
    setCardType();
});
...
<fieldset id="wc-yapay_intermediador-cc-payment-form" data-yapay="payment-form" onclick=inputCPFYapay()>
    ...
    <label for="tcPaymentMethod" style="display:none;">Formas de pagamento</label>
        <ul style="margin: 30px 0; display:none;">
            <?php
                $imgSrc = "";
    ...
    <div id="wc-yapay_intermediador-cc-credit-card-form" class="wc-yapay_intermediador-cc-method-form">
        <div class="form-row form-row-wide linha1">
            ...
            <p class="form-row form-row-first">
                <label for="wc-yapay_intermediador-cc-card-holder-name"><?php _e( 'Nome no Cartão', 'woocommerce-wc-yapay_intermediador-cc' ); ?> <span class="required">*</span></label>
        ...
        <div class="clear"></div>
        <p class="form-row form-row-first">
            <label for="wc-yapay_intermediador-cc-card-expiry"><?php _e( 'Data de Validade (MM/YY)', 'woocommerce-wc-yapay_intermediador-cc' ); ?> <span class="required">*</span></label>
